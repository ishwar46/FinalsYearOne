...
// A merge operation can only be performed on two adjacent elements. The result of a merge operation is that
// the two adjacent elements are replaced with their sum.
